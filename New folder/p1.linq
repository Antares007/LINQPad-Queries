<Query Kind="Program">
  <Reference>D:\temp\PolGen\Fosta\PolisisGeneracia.dll</Reference>
...
void Main()
{
	var pak = GetPaketi();
	pak.Dump();
	File.WriteAllBytes(@"D:\temp\PolGen\pak.old", Serialize(pak));
...
private static void Show(string file)
{
	...
	File.WriteAllBytes(file+".pdf",newFromOld.GadaikvanePdfShi());
